    ...
    <section className="PrivacyPolicy">
      <div>
        ...
        <p>
          ...
          of the BOTLabs GmbH. The use of the Internet pages of the BOTLabs GmbH
        ...
        <p>
          ...
          the BOTLabs GmbH. By means of this data protection declaration, our
        ...
        <p>
          As the controller, the BOTLabs GmbH has implemented numerous technical
        ...
        <p>
          The website of the BOTLabs GmbH collects a series of general data and
        ...
        <p>
          When using these general data and information, the BOTLabs GmbH does
          ...
          prosecution in case of a cyber-attack. Therefore, the BOTLabs GmbH
        ...
        <h2>4. Routine erasure and blocking of personal data</h2>
        <p>
        ...
        <p>
          ...
          wishes to request the erasure of personal data stored by the BOTLabs
          GmbH, he or she may, at any time, contact any employee of the
          controller. An employee of BOTLabs GmbH shall promptly ensure that the
        ...
        <p>
          ...
          required. An employees of the BOTLabs GmbH will arrange the necessary
        ...
        <p>
          ...
          stored by the BOTLabs GmbH, he or she may at any time contact any
          employee of the controller. The employee of the BOTLabs GmbH will
        ...
        <p>
          ...
          at any time contact any employee of the BOTLabs GmbH.
        </p>
        ...
        <p>
          The BOTLabs GmbH shall no longer process the personal data in the
        ...
        <p>
          ...
          to such direct marketing. If the data subject objects to the BOTLabs
          GmbH to the processing for direct marketing purposes, the BOTLabs GmbH
        ...
        <p>
          ...
          data concerning him or her by the BOTLabs GmbH for scientific or
        ...
        <p>
          ...
          any employee of the BOTLabs GmbH. In addition, the data subject is
        ...
        <p>
          ...
          it is based on the data subject's explicit consent, the BOTLabs GmbH
        ...
        <h2>
          7. The legitimate interests pursued by the controller or by a third
          party
        </h2>
        <p>
        ...
        <h2>8. Period for which the personal data will be stored</h2>
        <p>
        ...
        <h2>10. Existence of automated decision-making</h2>
        <p>
        ...
        <p>
          ...
          <a href="https://dg-datenschutz.de/?lang=en" target="_blank">
            German Association for Data Protection
          </a>
          <span>that was developed in cooperation with </span>
          <a
            href="https://www.wbs-law.de/eng/practice-areas/internet-law/it-law/"
            target="_blank"
          >
            Privacy Lawyers
          </a>
          <span> from WILDE BEUGER SOLMECKE, Cologne.</span>
        </p>
      </div>
    </section>
  )
