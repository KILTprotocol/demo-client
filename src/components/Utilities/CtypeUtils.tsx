 ...
 */
export function fromInputModel(ctypeInput: any): sdk.CType {
 ...
 */
export function getCTypeInputModel(ctype: sdk.CType): any {
  // create clone
 ...
 */
export function getClaimInputModel(ctype: sdk.ICType, lang?: string): any {
  // create clone
  const result = JSON.parse(JSON.stringify(ctype.schema))
